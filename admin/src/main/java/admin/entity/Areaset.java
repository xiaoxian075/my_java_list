...
public class Areaset implements Serializable {
	...
	public Areaset(BigInteger as_id, int ship_id, Float express_start, BigDecimal express_price, Float express_plus,
			BigDecimal express_priceplus, String express_id, int default_ship) {
		super();
		this.as_id = as_id;
